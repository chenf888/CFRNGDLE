...
(function() {
    ...
    { id: 'len-10', name: '十位数',   emoji: '🔟',   score: 9,           rarity: '平庸',
        check: function(d) { return U.getEffectiveLength(d) === 10; } },
    { id: 'len-9',  name: '九位数',   emoji: '9️⃣',   score: 90,          rarity: '普通',
        check: function(d) { return U.getEffectiveLength(d) === 9; } },
    { id: 'len-8',  name: '八位数',   emoji: '8️⃣',   score: 900,         rarity: '罕见',
        check: function(d) { return U.getEffectiveLength(d) === 8; } },
    { id: 'len-7',  name: '七位数',   emoji: '7️⃣',   score: 9000,        rarity: '稀有',
        check: function(d) { return U.getEffectiveLength(d) === 7; } },
    { id: 'len-6',  name: '六位数',   emoji: '6️⃣',   score: 90000,       rarity: '史诗',
        check: function(d) { return U.getEffectiveLength(d) === 6; } },
    { id: 'len-5',  name: '五位数',   emoji: '5️⃣',   score: 900000,      rarity: '传说',
        check: function(d) { return U.getEffectiveLength(d) === 5; } },
    { id: 'len-4',  name: '四位数',   emoji: '4️⃣',   score: 9000000,     rarity: '神话',
        check: function(d) { return U.getEffectiveLength(d) === 4; } },
    { id: 'len-3',  name: '三位数',   emoji: '3️⃣',   score: 90000000,    rarity: '超越',
        check: function(d) { return U.getEffectiveLength(d) === 3; } },
    { id: 'len-2',  name: '两位数',   emoji: '2️⃣',   score: 900000000,   rarity: '终结',
        check: function(d) { return U.getEffectiveLength(d) === 2; } },
    { id: 'len-1',  name: '一位数',   emoji: '1️⃣',   score: 9000000000,  rarity: '终结',
    ...
    { id: 'palindrome',      name: '回文数',     emoji: '🔁',     score: 999,   rarity: '罕见',
    ...
    // N连系列
    { id: 'triple',          name: '三连',       emoji: '3️⃣🎯',   score: 33,    rarity: '普通',
    ...
    { id: 'double-double',   name: '双双对',     emoji: '👯👯',   score: 9,   rarity: '平庸',
        check: function(d) {
    ...
    { id: 'all-consec',      name: '全连续',     emoji: '🔗',     score: 9999,  rarity: '稀有',
        check: function(d) {
            var digits = [];
    ...
    // 3位子串 — 平庸
    { id: 'meme-233',     name: '猫笑',        emoji: '🐱',     score: 23,   rarity: '普通', check: function(d){return U.hasSubstring(d,'233');} },
    { id: 'meme-250',     name: '二百五',      emoji: '🤪',     score: 25,   rarity: '普通', check: function(d){return U.hasSubstring(d,'250');} },
    { id: 'meme-251',     name: '二五一',      emoji: '2️⃣5️⃣1️⃣',score: 25,    rarity: '普通', check: function(d){return U.hasSubstring(d,'251');} },
    { id: 'meme-404',     name: '未找到',      emoji: '❓',     score: 40,   rarity: '普通', check: function(d){return U.hasSubstring(d,'404');} },
    { id: 'meme-007',     name: '詹姆斯·邦德', emoji: '🔫',     score: 7,    rarity: '平庸', check: function(d){return U.hasSubstring(d,'007');} },
    { id: 'meme-520',     name: '我爱你',      emoji: '💕',     score: 52,   rarity: '普通', check: function(d){return U.hasSubstring(d,'520');} },
    { id: 'meme-521',     name: '我愿意',      emoji: '💍',     score: 52,   rarity: '普通', check: function(d){return U.hasSubstring(d,'521');} },
    { id: 'meme-119',     name: '火警',        emoji: '🚒',     score: 11,   rarity: '普通', check: function(d){return U.hasSubstring(d,'119');} },
    { id: 'meme-120',     name: '急救',        emoji: '🚑',     score: 12,   rarity: '普通', check: function(d){return U.hasSubstring(d,'120');} },
    { id: 'meme-110',     name: '报警',        emoji: '🚔',     score: 11,   rarity: '普通', check: function(d){return U.hasSubstring(d,'110');} },
    { id: 'meme-114',     name: '查号台',      emoji: '📞',     score: 11,   rarity: '普通', check: function(d){return U.hasSubstring(d,'114');} },
    { id: 'meme-992',     name: '救救',        emoji: '🆘',     score: 99,   rarity: '普通', check: function(d){return U.hasSubstring(d,'992');} },
    { id: 'meme-996',     name: '996工作制',   emoji: '💼',     score: 99,   rarity: '普通', check: function(d){return U.hasSubstring(d,'996');} },
    { id: 'meme-745',     name: '气死我',      emoji: '😤',     score: 74,   rarity: '普通', check: function(d){return U.hasSubstring(d,'745');} },
    { id: 'meme-748',     name: '气死吧',      emoji: '😡',     score: 74,   rarity: '普通', check: function(d){return U.hasSubstring(d,'748');} },
    { id: 'meme-810',     name: '八一零',      emoji: '8️⃣1️⃣0️⃣',score: 81,   rarity: '普通', check: function(d){return U.hasSubstring(d,'810');} },
    { id: 'meme-666',     name: '野兽之数',    emoji: '😈',     score: 66,   rarity: '普通', check: function(d){return U.hasSubstring(d,'666');} },
    { id: 'meme-777',     name: '幸运七',      emoji: '🍀',     score: 77,   rarity: '普通', check: function(d){return U.hasSubstring(d,'777');} },
    { id: 'meme-888',     name: '发财',        emoji: '💰',     score: 88,   rarity: '普通', check: function(d){return U.hasSubstring(d,'888');} },
    { id: 'meme-911',     name: '九一一',      emoji: '🏙️',    score: 91,   rarity: '普通', check: function(d){return U.hasSubstring(d,'911');} },
    { id: 'meme-000',     name: '三蛋',        emoji: '🥚',     score: 30,   rarity: '普通', check: function(d){return U.hasSubstring(d,'000');} },
    { id: 'meme-246',     name: '爱死了',      emoji: '💀💕',   score: 24,   rarity: '普通', check: function(d){return U.hasSubstring(d,'246');} },
    { id: 'meme-282',     name: '爱不爱',      emoji: '❓💕',   score: 28,   rarity: '普通', check: function(d){return U.hasSubstring(d,'282');} },
    { id: 'meme-360',     name: '想念你',      emoji: '🤔',     score: 36,   rarity: '普通', check: function(d){return U.hasSubstring(d,'360');} },
    { id: 'meme-592',     name: '我就爱',      emoji: '💖',     score: 59,   rarity: '普通', check: function(d){return U.hasSubstring(d,'592');} },
    { id: 'meme-596',     name: '我走了',      emoji: '🚶',     score: 59,   rarity: '普通', check: function(d){return U.hasSubstring(d,'596');} },
    { id: 'meme-921',     name: '就爱你',      emoji: '💝',     score: 92,   rarity: '普通', check: function(d){return U.hasSubstring(d,'921');} },
    { id: 'meme-400',     name: '四百',        emoji: '4️⃣0️⃣0️⃣',score: 40,   rarity: '普通', check: function(d){return U.hasSubstring(d,'400');} },
    { id: 'meme-578',     name: '我去吧',      emoji: '🏃',     score: 57,   rarity: '普通', check: function(d){return U.hasSubstring(d,'578');} },
    ...
    { id: 'meme-114514',  name: '好臭的数字',  emoji: '🤢',     score: 11451, rarity: '史诗', check: function(d){return U.hasSubstring(d,'114514');} },
    { id: 'meme-66686',   name: '溜溜溜达嘿',  emoji: '🏃💨',   score: 666,   rarity: '罕见', check: function(d){return U.hasSubstring(d,'66686');} },
    ...
    { id: 'seq-123', name: '一二三',   emoji: '1️⃣2️⃣3️⃣', score: 12, rarity: '普通', check: function(d){return U.hasSubstring(d,'123');} },
    { id: 'seq-234', name: '二三四',   emoji: '2️⃣3️⃣4️⃣', score: 23, rarity: '普通', check: function(d){return U.hasSubstring(d,'234');} },
    { id: 'seq-345', name: '三四五',   emoji: '3️⃣4️⃣5️⃣', score: 34, rarity: '普通', check: function(d){return U.hasSubstring(d,'345');} },
    { id: 'seq-456', name: '四五六',   emoji: '4️⃣5️⃣6️⃣', score: 45, rarity: '普通', check: function(d){return U.hasSubstring(d,'456');} },
    { id: 'seq-567', name: '五六七',   emoji: '5️⃣6️⃣7️⃣', score: 56, rarity: '普通', check: function(d){return U.hasSubstring(d,'567');} },
    { id: 'seq-678', name: '六七八',   emoji: '6️⃣7️⃣8️⃣', score: 67, rarity: '普通', check: function(d){return U.hasSubstring(d,'678');} },
    { id: 'seq-789', name: '七八九',   emoji: '7️⃣8️⃣9️⃣', score: 78, rarity: '普通', check: function(d){return U.hasSubstring(d,'789');} },
    { id: 'seq-890', name: '八九零',   emoji: '8️⃣9️⃣0️⃣', score: 89, rarity: '普通', check: function(d){return U.hasSubstring(d,'890');} },
    { id: 'seq-901', name: '九零一',   emoji: '9️⃣0️⃣1️⃣', score: 90, rarity: '普通', check: function(d){return U.hasSubstring(d,'901');} },
    // 降序3位
    { id: 'seq-098', name: '零九八',   emoji: '0️⃣9️⃣8️⃣', score: 9,  rarity: '平庸', check: function(d){return U.hasSubstring(d,'098');} },
    { id: 'seq-987', name: '九八七',   emoji: '9️⃣8️⃣7️⃣', score: 98, rarity: '普通', check: function(d){return U.hasSubstring(d,'987');} },
    { id: 'seq-876', name: '八七六',   emoji: '8️⃣7️⃣6️⃣', score: 87, rarity: '普通', check: function(d){return U.hasSubstring(d,'876');} },
    { id: 'seq-765', name: '七六五',   emoji: '7️⃣6️⃣5️⃣', score: 76, rarity: '普通', check: function(d){return U.hasSubstring(d,'765');} },
    { id: 'seq-654', name: '六五四',   emoji: '6️⃣5️⃣4️⃣', score: 65, rarity: '普通', check: function(d){return U.hasSubstring(d,'654');} },
    { id: 'seq-543', name: '五四三',   emoji: '5️⃣4️⃣3️⃣', score: 54, rarity: '普通', check: function(d){return U.hasSubstring(d,'543');} },
    { id: 'seq-432', name: '四三二',   emoji: '4️⃣3️⃣2️⃣', score: 43, rarity: '普通', check: function(d){return U.hasSubstring(d,'432');} },
    { id: 'seq-321', name: '三二一',   emoji: '3️⃣2️⃣1️⃣', score: 32, rarity: '普通', check: function(d){return U.hasSubstring(d,'321');} },
    { id: 'seq-210', name: '二一零',   emoji: '2️⃣1️⃣0️⃣', score: 21, rarity: '普通', check: function(d){return U.hasSubstring(d,'210');} },

    // 4位序列（普通）
    { id: 'seq-1234', name: '一二三四',   emoji: '1️⃣2️⃣3️⃣4️⃣', score: 123, rarity: '罕见', check: function(d){return U.hasSubstring(d,'1234');} },
    { id: 'seq-2345', name: '二三四五',   emoji: '2️⃣3️⃣4️⃣5️⃣', score: 234, rarity: '罕见', check: function(d){return U.hasSubstring(d,'2345');} },
    { id: 'seq-3456', name: '三四五六',   emoji: '3️⃣4️⃣5️⃣6️⃣', score: 345, rarity: '罕见', check: function(d){return U.hasSubstring(d,'3456');} },
    { id: 'seq-4567', name: '四五六七',   emoji: '4️⃣5️⃣6️⃣7️⃣', score: 456, rarity: '罕见', check: function(d){return U.hasSubstring(d,'4567');} },
    { id: 'seq-5678', name: '五六七八',   emoji: '5️⃣6️⃣7️⃣8️⃣', score: 567, rarity: '罕见', check: function(d){return U.hasSubstring(d,'5678');} },
    { id: 'seq-6789', name: '六七八九',   emoji: '6️⃣7️⃣8️⃣9️⃣', score: 678, rarity: '罕见', check: function(d){return U.hasSubstring(d,'6789');} },
    { id: 'seq-7890', name: '七八九零',   emoji: '7️⃣8️⃣9️⃣0️⃣', score: 789, rarity: '罕见', check: function(d){return U.hasSubstring(d,'7890');} },
    { id: 'seq-9876', name: '九八七六',   emoji: '9️⃣8️⃣7️⃣6️⃣', score: 987, rarity: '罕见', check: function(d){return U.hasSubstring(d,'9876');} },
    { id: 'seq-8765', name: '八七六五',   emoji: '8️⃣7️⃣6️⃣5️⃣', score: 876, rarity: '罕见', check: function(d){return U.hasSubstring(d,'8765');} },
    { id: 'seq-7654', name: '七六五四',   emoji: '7️⃣6️⃣5️⃣4️⃣', score: 765, rarity: '罕见', check: function(d){return U.hasSubstring(d,'7654');} },
    { id: 'seq-6543', name: '六五四三',   emoji: '6️⃣5️⃣4️⃣3️⃣', score: 654, rarity: '罕见', check: function(d){return U.hasSubstring(d,'6543');} },
    { id: 'seq-5432', name: '五四三二',   emoji: '5️⃣4️⃣3️⃣2️⃣', score: 543, rarity: '罕见', check: function(d){return U.hasSubstring(d,'5432');} },
    { id: 'seq-4321', name: '四三二一',   emoji: '4️⃣3️⃣2️⃣1️⃣', score: 432, rarity: '罕见', check: function(d){return U.hasSubstring(d,'4321');} },

    // 5位序列（罕见）
    { id: 'seq-12345', name: '一二三四五',     emoji: '🔢', score: 1234, rarity: '稀有', check: function(d){return U.hasSubstring(d,'12345');} },
    { id: 'seq-56789', name: '五六七八九',     emoji: '🔢', score: 5678, rarity: '稀有', check: function(d){return U.hasSubstring(d,'56789');} },
    { id: 'seq-67890', name: '六七八九零',     emoji: '🔢', score: 6789, rarity: '稀有', check: function(d){return U.hasSubstring(d,'67890');} },
    ...
    { id: 'phone-pattern',   name: '键盘形',     emoji: '⌨️',     score: 9,    rarity: '平庸',
    ...
    { id: 'double-zero',     name: '双零头',     emoji: '0️⃣0️⃣',   score: 100,   rarity: '罕见',
        check: function(d) { return d[0]==='0' && d[1]==='0'; } },
    { id: 'tail-zero',       name: '零结尾',     emoji: '0️⃣⬅️',   score: 10,    rarity: '普通',
    ...
    // 十、邻居/对子系列（8个）
    // ═══════════════════════════════════════════════
    { id: 'has-neighbor',   name: '邻居',     emoji: '🏘️',    score: 20,  rarity: '普通',
        check: function(d) { var c=0; for(var i=1;i<d.length;i++){if(Math.abs(+d[i]-+d[i-1])<=1)c++;} return c>=5; } },
    { id: 'far-neighbor',   name: '远邻',     emoji: '↔️',    score: 50, rarity: '普通',
        check: function(d) { return U.isFarNeighbor(d); } },
    { id: 'exact-pair',     name: '一对',     emoji: '👯',    score: 20, rarity: '普通',
        check: function(d) { return U.hasExactPair(d); } },
    { id: 'turtle',         name: '乌龟爬',   emoji: '🐢',    score: 500, rarity: '罕见',
        check: function(d) { return U.isTurtle(d); } },
    { id: 'sandwich',       name: '三明治',   emoji: '🥪',    score: 30, rarity: '普通',
        check: function(d) { return U.isSandwich(d); } },
    { id: 'symmetric-pair', name: '对称对',   emoji: '🦋',    score: 80, rarity: '普通',
        check: function(d) { return U.isSymmetricPairs(d); } },
    { id: 'has-cliff',      name: '悬崖',     emoji: '🧗',    score: 9, rarity: '平庸',
        check: function(d) { for(var i=1;i<d.length;i++){if(Math.abs(+d[i]-+d[i-1])>=9)return true;} return false; } },
    { id: 'has-plateau',    name: '高原',     emoji: '🏔️',    score: 100, rarity: '罕见',
        check: function(d) { return U.hasPlateau(d, 5); } },

    // ═══════════════════════════════════════════════
    // 十一、幂次数系列（5个）
    // ═══════════════════════════════════════════════
    { id: 'power-of-3',   name: '3的幂',   emoji: '3️⃣↑',  score: 500000000, rarity: '终结',
        check: function(d) { return U.isPowerOf(int(d), 3); } },
    { id: 'power-of-5',   name: '5的幂',   emoji: '5️⃣↑',  score: 500000000, rarity: '终结',
        check: function(d) { return U.isPowerOf(int(d), 5); } },
    { id: 'triangular',   name: '三角数',  emoji: '🔺',    score: 50000, rarity: '史诗',
        check: function(d) { return U.isTriangular(int(d)); } },
    { id: 'factorial',    name: '阶乘',    emoji: '!',     score: 100000000, rarity: '终结',
        check: function(d) {
            var n = int(d), f = 1, i = 2;
            while (f < n) { f *= i; i++; }
            return f === n;
        } },
    { id: 'catalan',      name: '卡塔兰数', emoji: '📐',  score: 80000000, rarity: '超越',
    ...
    // 十三、哈沙德/求和系列（10个）
    // ═══════════════════════════════════════════════
    { id: 'harshad',      name: '哈沙德数', emoji: '➗➕',  score: 5,  rarity: '平庸',
        check: function(d) { return U.isHarshad(d); } },
    { id: 'moran',        name: '莫兰数',   emoji: '➗🤵', score: 80, rarity: '普通',
        check: function(d) { return U.isMoran(d); } },
    { id: 'happy',        name: '快乐数',   emoji: '😊',  score: 9, rarity: '平庸',
        check: function(d) { return U.isHappy(int(d)); } },
    { id: 'deficient',    name: '亏数',     emoji: '📉',  score: 2,  rarity: '平庸',
        check: function(d) {
            var n = int(d), sum = 1, limit = Math.sqrt(n);
            for (var i = 2; i <= limit; i++) { if (n % i === 0) { sum += i; var j = n/i; if (j !== i) sum += j; } }
            return sum < n;
        } },
    { id: 'sum-11',       name: '和为11',   emoji: '➕1️⃣1️⃣', score: 11, rarity: '普通',
        check: function(d) { return U.sumOfDigits(d) === 11; } },
    { id: 'sum-22',       name: '和为22',   emoji: '➕2️⃣2️⃣', score: 22, rarity: '普通',
        check: function(d) { return U.sumOfDigits(d) === 22; } },
    { id: 'sum-33',       name: '和为33',   emoji: '➕3️⃣3️⃣', score: 33, rarity: '普通',
        check: function(d) { return U.sumOfDigits(d) === 33; } },
    { id: 'sum-44',       name: '和为44',   emoji: '➕4️⃣4️⃣', score: 444, rarity: '罕见',
        check: function(d) { return U.sumOfDigits(d) === 44; } },
    { id: 'sum-55',       name: '和为55',   emoji: '➕5️⃣5️⃣', score: 9, rarity: '平庸',
        check: function(d) { return U.sumOfDigits(d) === 55; } },
    { id: 'div-by-prod',  name: '积整除',   emoji: '✖️➗',  score: 5,  rarity: '平庸',
        check: function(d) { var p = U.productOfDigits(d); return p > 0 && int(d) % p === 0; } },

    // ═══════════════════════════════════════════════
    // 十四、数学猜想/特殊数（12个）
    // ═══════════════════════════════════════════════
    { id: 'mersenne',    name: '梅森素数',   emoji: '🔭',  score: 900000000, rarity: '终结',
    ...
    { id: 'sqrt2',       name: '√2前缀',    emoji: '√2️⃣', score: 14, rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '14142'); } },
    { id: 'sqrt3',       name: '√3前缀',    emoji: '√3️⃣', score: 17, rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '17320'); } },
    { id: 'sqrt5',       name: '√5前缀',    emoji: '√5️⃣', score: 22, rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '22360'); } },
    { id: 'ram-1729',    name: '拉马努金数', emoji: '🧮',  score: 1729, rarity: '稀有',
        check: function(d) { return U.hasSubstring(d, '1729'); } },
    { id: 'kap-6174',    name: '卡普雷卡',   emoji: '🔄',  score: 6174, rarity: '稀有',
        check: function(d) { return U.hasSubstring(d, '6174'); } },
    { id: 'kap-495',     name: '小卡普雷卡', emoji: '🔁',  score: 49,  rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '495'); } },
    { id: 'five-9s',     name: '五连九',     emoji: '9️⃣×5️⃣', score: 9999, rarity: '稀有',
        check: function(d) { return U.hasSubstring(d, '99999'); } },
    { id: 'collatz-ref', name: '3x+1',       emoji: '3️⃣✖️➕1️⃣', score: 3, rarity: '平庸',
        check: function(d) { return U.hasSubstring(d, '31'); } },
    { id: '11037',       name: '考拉兹候选', emoji: '🔢',  score: 110, rarity: '罕见',
        check: function(d) { return U.hasSubstring(d, '11037'); } },
    { id: 'perfect-sq-sum', name: '平方和完美', emoji: '➕🟰⬜', score: 50, rarity: '普通',
        check: function(d) { return U.isPerfectSquare(U.sumOfDigits(d)); } },

    // ═══════════════════════════════════════════════
    // 十五、只含特定数字（10个）
    // ═══════════════════════════════════════════════
    { id: 'prime-digits-only', name: '全质数字', emoji: '2️⃣3️⃣5️⃣7️⃣', score: 20, rarity: '普通',
        check: function(d) { return U.onlyFrom(d, [2,3,5,7]); } },
    { id: 'comp-digits-only', name: '全合数字', emoji: '4️⃣6️⃣8️⃣9️⃣', score: 20, rarity: '普通',
        check: function(d) { return U.onlyFrom(d, [4,6,8,9]); } },
    { id: 'fib-digits-only',  name: '全斐波数字', emoji: '🌀',  score: 10, rarity: '普通',
        check: function(d) { return U.onlyFrom(d, [0,1,2,3,5,8]); } },
    { id: 'no-prime-digit',   name: '无质数字', emoji: '🚫🤵', score: 5, rarity: '平庸',
        check: function(d) { return U.noneFrom(d, [2,3,5,7]); } },
    { id: 'all-ten-digits',   name: '十全十美', emoji: '🔟',  score: 5000, rarity: '稀有',
        check: function(d) { return U.uniqueDigitCount(d) === 10; } },
    { id: 'only-zero-one',    name: '只有0和1', emoji: '0️⃣1️⃣', score: 100, rarity: '罕见',
        check: function(d) { return U.onlyFrom(d, [0,1]); } },
    { id: 'half-even-odd',    name: '奇偶平衡', emoji: '⚖️',  score: 5, rarity: '平庸',
        check: function(d) { return U.halfEvenHalfOdd(d, 0); } },
    { id: 'one-side',         name: '一边倒',   emoji: '↗️',  score: 8, rarity: '平庸',
        check: function(d) { return U.onlyFrom(d, [0,1,2,3,4]) || U.onlyFrom(d, [5,6,7,8,9]); } },
    { id: 'no-even',          name: '无偶数',   emoji: '🚫2️⃣', score: 4, rarity: '平庸',
        check: function(d) { return U.onlyFrom(d, [1,3,5,7,9]); } },
    { id: 'no-odd',           name: '无奇数',   emoji: '🚫1️⃣', score: 4, rarity: '平庸',
        check: function(d) { return U.onlyFrom(d, [0,2,4,6,8]); } },

    // ═══════════════════════════════════════════════
    // 十六、黄金分割 φ 及衍生（6个）
    // ═══════════════════════════════════════════════
    { id: 'phi-5',        name: 'φ连续5位', emoji: 'φ5️⃣', score: 161, rarity: '罕见',
        check: function(d) { return U.hasSubstring(d, '16180'); } },
    { id: 'phi-6',        name: 'φ连续6位', emoji: 'φ6️⃣', score: 1618, rarity: '稀有',
        check: function(d) { return U.hasSubstring(d, '161803'); } },
    { id: 'phi-inv',      name: 'φ倒数',     emoji: 'φ🔄', score: 618, rarity: '罕见',
        check: function(d) { return U.hasSubstring(d, '61803'); } },
    { id: 'golden-angle', name: '黄金角',    emoji: '📐',  score: 13, rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '1375'); } },
    { id: 'a4-ratio',     name: 'A4纸比例',  emoji: '📄',  score: 29, rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '297'); } },
    { id: 'fib-ratio',    name: '斐波那契比', emoji: 'φ🌀', score: 161, rarity: '罕见',
        check: function(d) {
    ...
    // 十七、网络/文化梗补充（20个）
    // ═══════════════════════════════════════════════
    { id: 'meme-7355608',  name: 'CSGO炸弹',   emoji: '💣',   score: 7355, rarity: '稀有',
        check: function(d) { return U.hasSubstring(d, '7355608'); } },
    { id: 'meme-8675309',  name: 'Jenny号码',  emoji: '📞',   score: 86,  rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '8675309'); } },
    { id: 'meme-58008',    name: '计算器梗',   emoji: '🔢',   score: 58,  rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '58008'); } },
    { id: 'meme-5318008',  name: '大计算器梗', emoji: '🍑',   score: 531,  rarity: '罕见',
        check: function(d) { return U.hasSubstring(d, '5318008'); } },
    { id: 'meme-24601',    name: '冉阿让',     emoji: '⛓️',  score: 24,  rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '24601'); } },
    { id: 'meme-112358',   name: '斐波片段',   emoji: '🌀🎵', score: 112, rarity: '罕见',
        check: function(d) { return U.hasSubstring(d, '112358'); } },
    { id: 'meme-555',      name: '哈哈哈',     emoji: '😂',   score: 55,  rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '555'); } },
    { id: 'meme-444',      name: '四四四',     emoji: '4️⃣4️⃣4️⃣', score: 44, rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '444'); } },
    { id: 'meme-333',      name: '三三三',     emoji: '3️⃣3️⃣3️⃣', score: 33, rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '333'); } },
    { id: 'meme-222',      name: '二二二',     emoji: '2️⃣2️⃣2️⃣', score: 22, rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '222'); } },
    { id: 'meme-111',      name: '一一一',     emoji: '1️⃣1️⃣1️⃣', score: 11, rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '111'); } },
    { id: 'meme-999',      name: '九九九',     emoji: '9️⃣9️⃣9️⃣', score: 99, rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '999'); } },
    { id: 'meme-369',      name: '特斯拉数',   emoji: '⚡3️⃣6️⃣9️⃣', score: 369, rarity: '罕见',
        check: function(d) { return U.hasSubstring(d, '369'); } },
    { id: 'meme-108',      name: '一百零八',   emoji: '🕉️',  score: 108, rarity: '罕见',
        check: function(d) { return U.hasSubstring(d, '108'); } },
    { id: 'meme-432',      name: '宇宙频率',   emoji: '🎵',   score: 432, rarity: '罕见',
        check: function(d) { return U.hasSubstring(d, '432'); } },
    { id: 'meme-528',      name: '爱的频率',   emoji: '💚',   score: 528, rarity: '罕见',
        check: function(d) { return U.hasSubstring(d, '528'); } },
    { id: 'meme-963',      name: '神圣频率',   emoji: '🙏',   score: 963, rarity: '罕见',
        check: function(d) { return U.hasSubstring(d, '963'); } },
    { id: 'meme-481516',   name: 'Lost数字',   emoji: '🏝️',  score: 4815, rarity: '稀有',
        check: function(d) { return U.hasSubstring(d, '4815162342'); } },
    { id: 'meme-80085',    name: '计算器单词', emoji: '📟',   score: 80,  rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '80085'); } },
    { id: 'meme-1134',     name: '倒过来读',   emoji: '🙃',   score: 11,  rarity: '普通',
        check: function(d) { return U.hasSubstring(d, '1134'); } },

    // ═══════════════════════════════════════════════
    // 十八、更多模式徽章（12个）
    // ═══════════════════════════════════════════════
    { id: 'inc-run-6',    name: '六级台阶', emoji: '📈6️⃣', score: 60, rarity: '普通',
        check: function(d) { return U.hasIncreasingRun(d, 6); } },
    { id: 'dec-run-6',    name: '六级滑坡', emoji: '📉6️⃣', score: 60, rarity: '普通',
        check: function(d) { return U.hasDecreasingRun(d, 6); } },
    { id: 'abab',         name: 'ABAB模式', emoji: '🔀',  score: 12, rarity: '普通',
        check: function(d) { return U.hasABAB(d); } },
    { id: 'abcabc',       name: 'ABCABC',   emoji: '🔁',  score: 123, rarity: '罕见',
        check: function(d) { return U.hasABCABC(d); } },
    { id: 'starts-aba',   name: '镜前镜后', emoji: '🪞',  score: 5, rarity: '平庸',
        check: function(d) { return U.startsWithABA(d); } },
    { id: 'wave-8',       name: '八次波浪', emoji: '🌊',  score: 80, rarity: '普通',
        check: function(d) { return U.isWave(d, 8); } },
    { id: 'roller-2',     name: '过山车',   emoji: '🎢',  score: 9, rarity: '平庸',
        check: function(d) { return U.isRollercoaster(d, 4); } },
    { id: 'rotation',     name: '旋转木马', emoji: '🎠',  score: 80, rarity: '普通',
        check: function(d) {
    ...
    { id: 'eleven-sum-10',name: '全邻和10', emoji: '🔟➕', score: 100, rarity: '罕见',
        check: function(d) { return U.allAdjacentSum10(d); } },
    { id: 'monotonic',    name: '单调',     emoji: '➡️',  score: 50, rarity: '普通',
        check: function(d) { return U.isNonDecreasing(d) || U.isNonIncreasing(d); } },
    { id: 'every-other',  name: '隔位相等', emoji: '🏁',  score: 80, rarity: '普通',
        check: function(d) {
    ...
    // ---- 数论 ----
    { id: 'pronic',           name: '普洛尼克数', emoji: '🧮', score: 100000, rarity: '传说',
    ...
    // ---- 组合模式 ----
    { id: 'full-house',       name: '满堂彩',     emoji: '🏠',  score: 9, rarity: '平庸',
        check: function(d) { return U.hasFullHouse(d); } },
    { id: 'contig-full-house',name: '连续满堂彩', emoji: '🏰',  score: 9, rarity: '平庸',
        check: function(d) { return U.hasContiguousFullHouse(d); } },
    { id: 'snake-eyes',       name: '蛇眼',       emoji: '🎲',  score: 9, rarity: '平庸',
    ...
    { id: 'devil-number',     name: '魔鬼之数',   emoji: '😈',  score: 666, rarity: '罕见',
        check: function(d) { return U.hasSubstring(d, '666') && U.hasSubstring(d, '777'); } },

    // ---- 书挡/镜 ----
    { id: 'bookends',         name: '书挡',       emoji: '📚',  score: 100, rarity: '罕见',
        check: function(d) { return U.hasBookends(d, 2); } },
    { id: 'mirror-bookends',  name: '镜像书挡',   emoji: '📖',  score: 150, rarity: '罕见',
        check: function(d) { return U.hasMirrorBookends(d, 2); } },
    { id: 'pocket-mirror',    name: '口袋镜',     emoji: '🪞',  score: 9, rarity: '平庸',
    ...
    // ---- 打乱连续 ----
    { id: 'scrambled-3',      name: '打乱三连',   emoji: '🔀3️⃣', score: 9, rarity: '平庸',
        check: function(d) { return U.hasScrambledConsecutive(d, 3); } },
    { id: 'scrambled-4',      name: '打乱四连',   emoji: '🔀4️⃣', score: 99, rarity: '普通',
    ...
    { id: 'hop',              name: '跳一跳',     emoji: '🦘',  score: 9, rarity: '平庸',
        check: function(d) { return U.hasHop(d, 2); } },
    { id: 'double-hop',       name: '双跳',       emoji: '🦘🦘', score: 9, rarity: '平庸',
        check: function(d) { return U.hasDoubleHop(d, 2); } },
    { id: 'dunes',            name: '沙丘',       emoji: '🐫',  score: 9, rarity: '平庸',
    ...
    { id: 'century',          name: '世纪和',     emoji: '💯',  score: 10000, rarity: '史诗',
    ...
    { id: 'big-brother',      name: '老大哥',     emoji: '👁️',  score: 198, rarity: '罕见',
        check: function(d) { return U.hasSubstring(d, '1984'); } },
    { id: 'contentment',      name: '知足',       emoji: '😌',  score: 9, rarity: '平庸',
